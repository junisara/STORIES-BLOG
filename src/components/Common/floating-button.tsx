  ...
  return (
    <div className="group fixed bottom-4 right-4 xl:hidden">
      <div className="group relative flex flex-col-reverse">
        ...
        <CopyLinkButton size={22} className={cn('absolute bottom-0 right-0 transition', visible && '-translate-y-12')} />
        <ScrollToComment size={22} className={cn('absolute bottom-0 right-0 transition', visible && '-translate-y-24')} />
